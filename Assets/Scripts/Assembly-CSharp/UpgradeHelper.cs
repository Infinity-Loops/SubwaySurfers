...
public class UpgradeHelper : MonoBehaviour
{
	...
	public void UpgradePurchased(PowerupType type)
	{
		...
		case PowerupType.skipmission1:
			...
			FlurryAndroid.logEvent("Boost Mission Skip purchased", dictionary);
		...
		{
		case PowerupType.headstart500:
			FlurryAndroid.logEvent("Boost Headstart500 purchased");
			break;
		case PowerupType.headstart2000:
			FlurryAndroid.logEvent("Boost Headstart2000 purchased");
			break;
		case PowerupType.hoverboard:
			FlurryAndroid.logEvent("Boost Hoverboard purchased");
			break;
		case PowerupType.coinmagnet:
			dictionary = new Dictionary<string, string>();
			dictionary.Add("Tier", PlayerInfo.Instance.GetCurrentTier(type).ToString());
			FlurryAndroid.logEvent("Boost Coinmagnet purchased", dictionary);
			break;
		case PowerupType.doubleMultiplier:
			dictionary = new Dictionary<string, string>();
			dictionary.Add("Tier", PlayerInfo.Instance.GetCurrentTier(type).ToString());
			FlurryAndroid.logEvent("Boost 2x multiplier purchased", dictionary);
			break;
		case PowerupType.jetpack:
			dictionary = new Dictionary<string, string>();
			dictionary.Add("Tier", PlayerInfo.Instance.GetCurrentTier(type).ToString());
			FlurryAndroid.logEvent("Boost jetpack purchased", dictionary);
			break;
		case PowerupType.letters:
			dictionary = new Dictionary<string, string>();
			dictionary.Add("Tier", PlayerInfo.Instance.GetCurrentTier(type).ToString());
			FlurryAndroid.logEvent("Boost letters purchased", dictionary);
			break;
		case PowerupType.supersneakers:
			dictionary = new Dictionary<string, string>();
			dictionary.Add("Tier", PlayerInfo.Instance.GetCurrentTier(type).ToString());
			FlurryAndroid.logEvent("Boost supersneakers purchased", dictionary);
			break;
		case PowerupType.mysterybox:
			FlurryAndroid.logEvent("Boost MysteryBox purchased");
			break;
		}
	}
