...
public class Jetpack : CharacterState
{
	...
	public void Awake()
	{
		...
		isInGame.OnChange = (Variable<bool>.OnChangeDelegate)Delegate.Combine(isInGame.OnChange, new Variable<bool>.OnChangeDelegate(_003CAwake_003Em__B));
	}
	...
	[CompilerGenerated]
	private void _003CAwake_003Em__B(bool isInGame)
	{
		if (!isInGame)
		{
			TurnOffEffects();
